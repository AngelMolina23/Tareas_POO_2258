...
public class VentanaLibro extends JFrame {
    ...
    public VentanaLibro(String title) throws HeadlessException {
        ...
        panel1.setBackground(new Color(86, 89, 238));
        lblId = new JLabel("Id: ");
        ...
        panel2.setBackground(new Color(98, 243, 67));
        ...
        panel3.setBackground(new Color(114, 245, 250));

        //panel4
        panel4 = new JPanel(new FlowLayout());
        panel4.setBackground(new Color(203, 91, 67));
